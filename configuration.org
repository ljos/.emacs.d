...
** menu bar
   ...
   #+END_SRC
** font
   I haven't decided what font to use on most systems, but on OS X I
   really like one of the built in fonts called menlo. I also set the
   font size a bit bigger at 14pt.
